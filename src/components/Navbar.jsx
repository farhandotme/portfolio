  ...
  return (
    <div className="fixed bottom-0 left-0 w-full z-50 flex justify-center pb-2">
      <motion.div
        ...
        className={`rounded-full px-6 py-2 flex items-center space-x-1 sm:space-x-2 md:space-x-3
              ...
              <Link to={item.path}>
                <motion.div
                  className={`flex flex-col items-center justify-center p-2 rounded-full
                    ...
                    ${isActive ? 'text-[#64ffda]' : 'text-gray-600 dark:text-gray-300 hover:text-[#64ffda]'}`}
